...
$id = $_GET["id"];
 ...
 //３．データ登録SQL作成 //ここにカラム名を入力する
    ...
    $sql =  "SELECT * FROM arsenal_member_table WHERE id=:id";
...
?>
  ...
  <form method="post" action="mem_update.php">
    ...
    <fieldset style="margin:20px">
      ...
      <label>背番号：<input type="text" class="form-control" name="number" value="<?=$row['number'] ?>"></label><br>
      ...
      <label>推定市場価格(万€)：<input type="text" class="form-control" name="value" value="<?=$row['value'] ?>"></label><br>
      <label>ポジション：
