...
$sql =  "INSERT INTO arsenal_transfer_table(id,indate, name, country, birth,age,
position,value,comment )VALUES(NULL,sysdate(), :name,  :country, :birth, $age, :position, :value, :comment)";
